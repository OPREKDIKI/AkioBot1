...
rows: [
{title: `⟐ Donasi ⟐`, rowId: ".donasi", description: "ᴅᴏɴᴀsɪ ʙᴇᴛᴜʟᴀɴ ʏᴀ ᴊᴀɴ ᴄᴜᴍᴀɴ ʟɪᴀᴛ"},
{title: `⟐ Sewa Bot ⟐`, rowId: ".sewa", description: "ɴʏᴇᴡᴀ ʏᴀɴɢ sᴇʀɪᴜs ᴅᴏɴɢ"},
{title: `⟐ Script ⟐`, rowId: ".sc", description: "ᴄɪʜ ᴘᴇɴɢᴀᴍʙɪʟ sᴄ"},
]}]
...
▢ ▱▱▱▱▱▱▱▱▱▱▱▱ ▢
`
let fot = `Nᴏᴛᴇ!! : ᴍᴇɴᴇᴍᴜᴋᴀɴ ᴇʀʀᴏʀ? ᴋᴇᴛɪᴋ #report 
`
const listMessage = {
text: tett,
footer: fot,
